...
console.log ( "The parking system is created...\n" )

let prompt = 'Select an action to function [ p - park, u - unpark, m - map, x - exit ]:'
      ...
      case 'u':
        rl.question('Location of vehicle to unpark. Seperate by a space [row column]: ', function (loc) {
            ...
            if ( strLoc.length >= 2 ) {
                ...
                console.log('This vehicle is unparked!')
            }
        })
        break
      case 'm':
...
rl.on("close", function () {
    console.log("\nThank you for parking! We are pleased to serve you.")
    process.exit(0)
})